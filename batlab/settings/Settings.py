...
class Settings:
    ...
    def view(self):
        ...
        print("OCV_chargeInterval             :",self.ocv_charge_interval               )
        print("impedanceChargeInterval        :",self.impedance_charge_interval         )
        print("CVdischarge                    :",self.cv_discharge                      )
        print("testType                       :",self.test_type                         )
        print("primeMaxCycles                 :",self.prime_max_cycles                  )
        print("charges                        :",self.charges                           )
        print("discharges                     :",self.discharges                        )
        print("firstStage                     :",self.first_stage                       )