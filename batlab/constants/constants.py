...
MODE_STOPPED           = 0x0006
MODE_CV_CHARGE         = 0x0007
MODE_CV_DISCHARGE      = 0x0008
MODE_LIST = ['MODE_NO_CELL','MODE_BACKWARDS','MODE_IDLE','MODE_CHARGE','MODE_DISCHARGE','MODE_IMPEDANCE','MODE_STOPPED','MODE_CV_CHARGE','MODE_CV_DISCHARGE']
...
ERR_NO_PSU             = 0x0100
ERR_LOW_VCC            = 0x0800
ERR_LIST = ['ERR_VOLTAGE_LIMIT_CHG','ERR_VOLTAGE_LIMIT_DCHG','ERR_CURRENT_LIMIT_CHG','ERR_CURRENT_LIMIT_DCHG','ERR_TEMP_LIMIT_CHG','ERR_TEMP_LIMIT_DCHG','ERR_BACKWARDS','ERR_NO_CELL','ERR_NO_PSU','ERR_HW_CURRENT_LIMIT','','ERR_LOW_VCC']
...
l_test_type= ["DISCHARGE","CYCLE","PRIME","CHARGE"]